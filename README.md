...
***0-9*** - Syntax:0=minTime:maxTime:duration - Setzt ein Symbol mit den entsprechenden Timingwerten.  Symbole werden als eine Zahl zwischen 0 und 9 definiert. Syntax:0=minTime:maxTime:duration. Wir wollen ein Symbol definieren mit einem HIGH Pegel von 150ys beim senden. Außerdem soll das Symbol erkannt werden, wenn sich der Pegel zwischen 100ys HIGH  und 200ys HIGH befindet. Beispiel: 0=100:200:150. LOW Pegel werden mit einem negativem Vorzeichen gesetzt. Beispiel: 0=-200:-100:-150. Bei LOW-Definitionen ist zu beachten, das die Begrenzungswerte vertauscht werden, weil mit negative Vorzeichen umgekehrt gerechnet wird.  
